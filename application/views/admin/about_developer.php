...
@Website: https://github.com/Wiraapriliansyah
...
<head>
	...
	<title>Tentang Developer - Learnlynx</title>
	<!-- General CSS Files -->
		...
		<div class="main-wrapper">
				...
				<ul class="navbar-nav navbar-right">
					<li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
						...
						<div class="dropdown-menu dropdown-menu-right">
							<div class="dropdown-title">Admin - Learnlynx</div>
					...
					<ul class="sidebar-menu">
						...
						<li class="nav-item dropdown">
							<a href="#" class="nav-link has-dropdown"><i class="fas fa-chalkboard-teacher"></i>
								<span>Dosen</span></a>
							<ul class="dropdown-menu">
								<li><a class="nav-link" href="<?= base_url('admin/data_') ?>">Data Dosen</a>
								</li>
			...
			<div class="main-content">
				<section class="section">
					<div class="">
						<div class="" data-background="https://i.pinimg.com/564x/8b/00/39/8b00398a68622fc3411eb141eb5b345e.jpg">
							<div class="col-md-4 mx-auto rounded-circle bg-white p-3" style="border-radius:3px;box-shadow:rgba(0, 0, 0, 0.03) 0px 4px 8px 0px;">
								<img src="<?= base_url('assets/img/') ?>wira.png" class="card-img-top rounded-circle img-responsive" alt="...">
							</div>
						</div>
					</div>
					<br>
					<div class="">
						<div class="card" style="width:100%;">
							<div class="card-body">
								<h2 class="card-title" style="color: black;">Wira Apriliansyah Saputra</h2>
								<hr>
								<p class="card-text">Learnlynx, sebuah platform edukasi open-source yang dikembangkan oleh Wira Apriliansyah Saputra,
								menawarkan lingkungan belajar yang lengkap dengan video, materi, dan sistem ujian yang tersedia secara gratis.
								Dengan tujuan untuk mendukung proses belajar mengajar yang fleksibel, Learnlynx memungkinkan siswa dan guru untuk belajar dan mengajar kapan saja dan di mana saja. </p>
							</div>
						</div>
					</div>
					<br>
