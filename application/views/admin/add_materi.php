                                        ...
                                        <form method="post" enctype="multipart/form-data" action="<?= base_url('guru/add_materi') ?>">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <small>List Dosen sudah tersedia di autocomplete, anda hanya
                                                        perlu klik input areanya atau dengan cara menulis nama dan
                                            ...
                                            <div class="form-group">
                                                ...
                                                <small>Jika nama matkul sudah berganti artinya nama dosen yang anda
