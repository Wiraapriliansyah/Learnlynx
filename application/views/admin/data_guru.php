...
<head>
    ...
    <title>Data Dosen - Learnlynx</title>
    <!-- General CSS Files -->
            ...
            <div class="main-content">
                <section class="section">
                    <div class="card" style="width:100%;">
                        <div class="card-body">
                            <h2 class="card-title" style="color: black;">Manajemen Data Dosen Learnlynx</h2>
                            <hr>
                            <p class="card-text"> Selamat datang di halaman Dosen. Sebagai admin, Anda memiliki akses penuh untuk mengelola dosen. Anda dapat menambahkan, mengedit, atau menghapus dosen sesuai kebutuhan. Setiap perubahan yang Anda buat akan langsung mempengaruhi pengalaman belajar pengguna kami. Terima kasih telah membantu kami dalam memberikan pendidikan berkualitas bagi semua pengguna. </p>
