...
@Website: https://git.hub/Wiraapriliansyah
...
<head>
    ...
    <title>Admin Menu Utama - Learnlynx</title>
    <!-- General CSS Files -->
            ...
            <div class="main-content">
                <section class="section">
                    <div class="section-header">
                        <h1 style="font-size: 27px; letter-spacing:-0.5px; color:black;">Menu Utama</h1>
                    </div>
                    <div class="row">
                    ...
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                ...
                                <hr>
                                <p class="card-text">Selamat datang di halaman Materi. Sebagai admin, Anda memiliki akses penuh untuk mengelola materi. Anda dapat menambahkan, mengedit, atau menghapus materi sesuai kebutuhan. Setiap perubahan yang Anda buat akan langsung mempengaruhi pengalaman belajar pengguna kami. Terima kasih telah membantu kami dalam memberikan pendidikan berkualitas bagi semua pengguna.</p>
