...
@About-Learnlynx :
Learnlynx, sebuah platform edukasi open-source yang dikembangkan oleh Wira Apriliansyah Saputra,
...
Learnlynx memungkinkan siswa dan guru untuk belajar dan mengajar kapan saja dan di mana saja.
-->
...
<head>
    <meta charset="utf-8" />
    <title>Learnlynx - Lecturer Page</title>
    ...
    <!--end::Layout Skins -->
    <link rel="shortcut icon" href="<?=base_url('assets')?>/img/faviconedu.png" />
    ...
    <div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed ">
        <div class="kt-header-mobile__logo">
            <a href="<?=base_url('guru/add_materi')?>">
                <img alt="Logo" src="<?=base_url('assets')?>/img/EDU.png" width="90px;" />
            </a>
        </div>
                ...
                <div class="kt-aside__brand kt-grid__item " id="kt_aside_brand">
                    <div class="kt-aside__brand-logo">
                        <a href="<?=base_url('guru')?>">
                            <img alt="Logo" width="35px;" src="<?=base_url('assets')?>/img/faviconedu.png" />
                        </a>
                    </div>
                </div>
                        ...
                        <ul class="kt-menu__nav ">
                            <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--submenu-fullheight kt-menu__item--open kt-menu__item--here"
                                aria-haspopup="true"><a href="<?=base_url('guru')?>" class="kt-menu__link"><i
                                        ...
                                        class="kt-menu__link-text">Applikasi</span><i
                            ...
                            <ul class="kt-menu__nav ">
                                <li class="kt-menu__item  kt-menu__item--active " aria-haspopup="true"><a
                                        href="<?=base_url('guru')?>" class="kt-menu__link "><span
                                            class="kt-menu__link-text">Menu Utama</span></a></li>
                                ...
                                <div class="kt-portlet kt-portlet--height-fluid kt-widget19">
                                    <div class="kt-portlet__body kt-portlet__body--fit">
                                        <div class="kt-widget19__pic kt-portlet-fit--top kt-portlet-fit--sides">
                                            <img src="<?=base_url('assets/')?>img/perpusbg.png" class=" img-fluid" alt=""
                                                srcset="">
...
?> !
                                            ...
                                            <div class="kt-widget19__labels">
                                                <a href="#" class="btn btn-label-light-o2 btn-bold btn-sm ">Learnlynx</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="kt-portlet__body">
                                        <div class="kt-widget19__wrapper">
                                            ...
                                            <div class="kt-widget19__text">
                                                Selamat datang di halaman Dosen Learnlynx, anda dapat menambah materi.
                                                Dalam materi anda dapat memasukan video, dan deskripsinya. Seemoga anda
                                                dapat menikmati Learnlynx!, kontak Administrator jika terjadi masalah
                        ...
                        <div class="kt-footer kt-grid__item kt-grid kt-grid--desktop kt-grid--ver-desktop">
                            <div class="kt-footer__copyright">
                                2023&nbsp;&copy;&nbsp;<a href="https://www.github.com/Wiraapriliansyah" target="_blank"
                                    class="kt-link">Wira Apriliansyah Saputra</a>
                            </div>
                            <div class="kt-footer__menu">
                                Made with &nbsp; <span class="" style="color: red"> &#10084;</span> &nbsp; by Wira 
                            </div>
                        </div>
