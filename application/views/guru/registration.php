...
<head>
    ...
    <title>Tambah Data Dosen - Learnlynx</title>
    <!-- General CSS Files -->
...
<body>
                            ...
                            <form method="POST" action="<?= base_url('admin/add_guru') ?>">
                                ...
                                <div id="" class="row">
                                    <div class="form-group col-12">
                                        <label>Mata Kuliah yang diajar</label>
    ...
    <footer class="main-footer">
        <div class="text-center">
            Copyright &copy; 2023 <div class="bullet"></div><a href="https://www.github.com/Wiraapriliansyah">Wira Apriliansyah Saputra</a>
        </div>
    </footer>
    <!-- End Footer -->
