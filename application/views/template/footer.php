...
@About-Learnlynx :
Web Edukasi Open Source yang dibuat oleh Wira Apriliansyah Saputra.
Learnlynx adalah Web edukasi yang dilengkapi video, materi dan sistem ujian
yang tersedia secara gratis. Learnlynx dibuat ditujukan agar para siswa dan
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-2  col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    ...
                    <ul class="list">
                        <li><a href="<?= base_url('welcome/tentang') ?>">Tentang Learnlynx</a></li>
                        <li><a href="<?= base_url('welcome/materi') ?>">Materi Learnlynx</a></li>
                        <li><a href="<?= base_url('welcome/kontak') ?>">Kontak Learnlynx</a></li>
                        <li><a href="https://undip.ac.id">Website Resmi Universitas</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-2  col-md-6 col-sm-6">
            ...
            <div class="col-lg-2  col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    ...
                    <ul class="list">
                        <li><a href="javaScript:void(0);">Akuntansi Keuangan Menengah 1</a></li>
                        <li><a href="javaScript:void(0);">Akuntansi Biaya</a></li>
                        <li><a href="javaScript:void(0);">Bahasa Inggris</a></li>
                        <li><a href="javaScript:void(0);">Analisis dan Desain Sistem</a></li>
            ...
            <div class="col-lg-2  col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    ...
                    <ul class="list">
                        <li>Sebagai mahasiswa Akuntansi di Universitas Diponegoro, saya memiliki minat yang kuat dalam memanfaatkan teknologi untuk meningkatkan efisiensi dan efektivitas dalam pendidikan. Dengan latar belakang akademik saya dalam bidang akuntansi, saya memahami pentingnya detail dan organisasi dalam pengelolaan informasi. Keterampilan ini, ditambah dengan minat saya dalam teknologi dan pemrograman, telah mendorong saya untuk menciptakan Learnlynx, sebuah platform eLearning yang dirancang untuk membantu siswa dan guru agar dapat terus belajar dan mengajar kapan saja dan di mana saja.</li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6">
                <h4 class="footer_title">Tentang Learnlynx</h4>
                <p>
                Learnlynx, sebuah platform edukasi open-source yang dikembangkan oleh Wira Apriliansyah Saputra, menawarkan lingkungan belajar yang lengkap dengan video, materi, dan sistem ujian yang tersedia secara gratis. Dengan tujuan untuk mendukung proses belajar mengajar yang fleksibel, Learnlynx memungkinkan siswa dan guru untuk belajar dan mengajar kapan saja dan di mana saja.
                </p>
            </div>
        </div>
        <div class="row footer-bottom d-flex justify-content-between align-items-center">
            <p class="col-lg-8 col-md-8 footer-text m-0">
                ...
                <a href="https://colorlib.com" target="_blank">Colorlib</a> <br> Learnlynx is made with <span class="text-danger"> &#10084;</span> by <a href="https://github.com/Wiraapriliansyah">Wira Apriliansyah Saputra </a> with MIT License
                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
            <div class="col-lg-4 col-md-4 footer-social">
                <a href="https://www.facebook.com/Wiraapr20"><i class="fa fa-facebook"></i></a>
                <a href="https://twitter.com"><i class="fa fa-twitter"></i></a>
                <a href="https://dribbble.com"><i class="fa fa-dribbble"></i></a>
                <a href="https://www.behance.net"><i class="fa fa-behance"></i></a>
                <a href="https://www.github.com/Wiraapriliansyah"><i class="fa fa-github"></i></a>
                <a href="https://www.instagram.com/wiraapr_"><i class="fa fa-instagram"></i></a>
            </div>
        </div>
    </div>
</footer>
