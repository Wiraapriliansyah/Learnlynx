...
<head>
    ...
    <meta content="Learnlynx dibuat ditujukan agar para siswa dan guru dapat terus belajar dan mengajar dimana saja dan kapan saja." name="Description" />
    <meta content="Learnlynx, E-learning, Open Source, Wira Apriliansyah Saputra, github, programmer indonesia" name="keywords" />
    <link rel="icon" href="<?= base_url('assets/') ?>img/faviconedu.png" type="image/png">
    <title>Learnlynx - Transformasi Dunia Pendidikan!</title>
    <!-- Bootstrap CSS -->
