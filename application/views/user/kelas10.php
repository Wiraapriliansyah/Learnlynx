        ...
        <div class="main_menu">
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container">
                    ...
                    <a class="navbar-brand logo_h" href="<?= base_url('welcome') ?>"><img src="<?= base_url('assets/') ?>img/EDU.png" alt=""></a>
        ...
        <div class="bg-white mx-auto p-4 buat-text" data-aos="fade-down" data-aos-duration="1400" style="width: 100%; border-radius:10px;">
            <div class="row" style="color: black; font-family: 'poppins';">
                <div class="col-md-12 mt-1">
                    ...
                    <p>Hello Students! Silahkan pilih mata kuliah yang akan kamu
                        akses
                        dan pilih materi yang ingin kamu pelajari! Selamat belajar!</p>
                    <hr>
                    ...
                    <h4 data-aos="fade-down" data-aos-duration="1700"><?php
                                                                        ...
                                                                        $this->session->userdata('email')])->row_array();
                                                                        echo $data['user']['nama'];
                                                                        ?> - Learnlynx Students</h3>
                        <h5>Mata Pelajaran Kelas A</h5>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row mt-4 mb-5">
            <div class="col-md-4 mb-2 d-flex justify-content-center" data-aos-duration="1900" data-aos="fade-right">
                <a href="<?= base_url('materi/matematika_x') ?>">
                    <div class="card-kelas">
                        <img src="<?= base_url('assets/') ?>img/akbi.png" class="card-img-top" alt="...">
                    </div>
                </a>
            </div>
            <div class="col-md-4 mb-2 d-flex justify-content-center" data-aos-duration="1900" data-aos="fade-down">
                <a href="<?= base_url('materi/ipa_x') ?>">
                    <div class="card-kelas">
                        <img src="<?= base_url('assets/') ?>img/akm1.png" class="card-img-top" alt="...">
                    </div>
                </a>
            </div>
            <div class="col-md-4 mb-2 d-flex justify-content-center" data-aos-duration="1900" data-aos="fade-left">
                <a href="<?= base_url('materi/indo_x') ?>">
                    <div class="card-kelas">
                        <img src="<?= base_url('assets/') ?>img/andes.png" class="card-img-top" alt="...">
                    </div>
                </a>
            </div>
        </div>
        ...
        <div class="row mt-4 mb-5">
            <div class="col-md-4 mb-2 d-flex justify-content-center" data-aos-duration="1900" data-aos="fade-right">
                <a href="<?= base_url('materi/inggris_x') ?>">
                    <div class="card-kelas">
                        <img src="<?= base_url('assets/') ?>img/bing.png" class="card-img-top" alt="...">
                    </div>
                </a>
            </div>
            <div class="col-md-4 mb-2 d-flex justify-content-center" data-aos-duration="1900" data-aos="fade-down">
                <a href="<?= base_url('materi/agama_x') ?>">
                    <div class="card-kelas">
                        <img src="<?= base_url('assets/') ?>img/pai.png" class="card-img-top" alt="...">
                    </div>
                </a>
            </div>
            <div class="col-md-4 mb-2 d-flex justify-content-center" data-aos-duration="1900" data-aos="fade-left">
