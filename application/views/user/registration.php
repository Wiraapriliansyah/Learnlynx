...
<head>
    ...
    <title>Learnlynx - Belajar Lebih Mudah Dimana Saja dan Kapan Saja!</title>
    <!-- Bootstrap CSS -->
...
<body style="background-color: #edf2f7">
            ...
            <div class="container">
                <div class="float-left">
                    <ul class="list header_social">
                        <li><a href="https://www.facebook.com/WiraApr20/"><i class="fa fa-facebook"></i></a></li>
                        <li><a href="https://twitter.com"><i class="fa fa-twitter"></i></a></li>
                        <li><a href="https://dribbble.com"><i class="fa fa-dribbble"></i></a></li>
                        <li><a href="https://www.behance.net"><i class="fa fa-behance"></i></a></li>
                        <li><a href="https://www.github.com/Wiraapriliansyah"><i class="fa fa-github"></i></a></li>
                        <li><a href="https://www.instagram.com/wiraapr_"><i class="fa fa-instagram"></i></a></li>
                    </ul>
                </div>
                <div class="float-right">
                    <a class="dn_btn" href="mailto:wiraapr20@gmail.com">wiraapr20@gmail.com</a>
                </div>
            </div>
        </div>
        <div class="main_menu">
    ...
    <section class="banner_area">
        <div class="banner_inner d-flex align-items-center">
            ...
            <img src="<?= base_url('assets/') ?>img/banner/Untitled design (4).png" alt="">
            </div>
            <div class="container">
                <div class="banner_content text-center">
                    <h2>Pendaftaran Learnlynx</h2>
                    <div class="page_link">
        ...
        <div class="row bg-registration p-3">
            <div class="col-md-12 text-center">
                <p class="registration-title font-weight-bold display-4 mt-4" style="font-size: 50px;">
                    Pendaftaran Learnlynx</p>
                <p style="line-height:-30px;margin-top:-20px;">Silahkan isi data dibawah ini </p>
                <hr>
            </div>
            ...
            <div class="col-md-6 mx-auto my-auto mt--5">
                <form action="<?= base_url('user/registration_act') ?>" method="post">
                    ...
                    <p class="terms">Dengan mendaftar anda menyetujui <i>privasi dan persyaratan
                            hukum yang berlaku</i>
                        baca selengkapnya <a href="#"></a></p>
